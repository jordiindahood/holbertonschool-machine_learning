...
class NST:
    ...
    def generate_image(
        ...
        Parameters:
        - iterations (int):
        The number of optimization steps to perform. Must be a positive integer.  # noqa: E501
        - step (int, optional):
        Interval at which to print the current cost, content cost, and style cost.  # noqa: E501
        If None, no intermediate outputs are displayed. Must be a positive integer  # noqa: E501
