...
def densenet121(growth_rate=32, compression=1.0):
    ...
    for layer in layers:
        myLayer, nb_filters = transition_layer(
            myLayer, nb_filters, compression
        )

        myLayer, nb_filters = dense_block(
            myLayer, nb_filters, growth_rate, layer
        )
